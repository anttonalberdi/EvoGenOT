...
forwardPos = list(map(lambda i: tagmap.get(i, forward[i]), range(len(forward))))
reversePos= list(map(lambda i: tagmap.get(i, reverse[i]), range(len(reverse))))
>>>>>>> 17f155113d39c9eae6fe9eeda93e2fd0149bf459
