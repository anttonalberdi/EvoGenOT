...
#
#
# @JacobAgerbo (<genomicsisawesome@gmail.com>)
...
p10.transfer(8, ER_mastermix, [well.bottom() for well in temp_plate.wells()])
...
temp_deck.set_temperature(4)
temp_deck.wait_for_temp()
p10.transfer(2, BGI_adapter, [well.bottom() for well in temp_plate.wells()],mix_after=(3, 10) , new_tip='always',  blow_out =True)

p10.transfer(8, Lig_mastermix, [well.top() for well in temp_plate.wells()], new_tip='once',  blow_out =True)
