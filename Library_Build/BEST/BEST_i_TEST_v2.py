...
## Adding 32µl sample to PCR plate and mixes after
    ...
    p50.aspirate(32, Sample_plate.wells_by_name()['A1'].bottom(2))
    # Dispensing 32.0 uL Samples to PCR plate in the bottom
    p50.dispense(32,PCR_plate.wells_by_name()['A1'].bottom(2))
    ...
    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['B1'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['B1'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['B1'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['B1'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['C1'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['C1'].bottom(2))
    ...
    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['D1'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['D1'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['D1'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['D1'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['E1'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['E1'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['E1'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['E1'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['F1'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['F1'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['F1'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['F1'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['G1'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['G1'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['G1'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['G1'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['H1'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['H1'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['H1'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['H1'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['A2'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['A2'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['A2'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['A2'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['B2'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['B2'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['B2'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['B2'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['C2'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['C2'].bottom(2))
    ...
    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['D2'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['D2'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['D2'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['D2'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['E2'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['E2'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['E2'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['E2'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['F2'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['F2'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['F2'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['F2'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['G2'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['G2'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['G2'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['G2'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['H2'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['H2'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['H2'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['H2'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['A3'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['A3'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['A3'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['A3'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['B3'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['B3'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['B3'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['B3'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['C3'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['C3'].bottom(2))
    ...
    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['D3'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['D3'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['D3'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['D3'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['E3'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['E3'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['E3'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['E3'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['F3'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['F3'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['F3'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['F3'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['G3'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['G3'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['G3'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['G3'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['H3'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['H3'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['H3'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['H3'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['A4'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['A4'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['A4'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['A4'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['B4'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['B4'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['B4'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['B4'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['C4'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['C4'].bottom(2))
    ...
    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['D4'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['D4'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['D4'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['D4'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['E4'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['E4'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['E4'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['E4'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['F4'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['F4'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['F4'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['F4'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['G4'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['G4'].bottom(2))
    p50.mix(3,40,PCR_plate.wells_by_name()['G4'].bottom(3))
    p50.blow_out(PCR_plate.wells_by_name()['G4'].bottom(10))
    p50.drop_tip()

    p50.pick_up_tip()
    p50.aspirate(32, Sample_plate.wells_by_name()['H4'].bottom(2))
    p50.dispense(32,PCR_plate.wells_by_name()['H4'].bottom(2))
