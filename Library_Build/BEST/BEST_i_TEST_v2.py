...
def run(BEST):
    ...
    list_of_rows_3 = ['A3','B3','C3','D3','E3','F3','G3','H3']
    for i in list_of_rows_3:
        p50.pick_up_tip()
        p50.aspirate(Sample_Vol, Sample_plate.wells_by_name()[i].bottom(2))
        p50.dispense(Sample_Vol,PCR_plate.wells_by_name()[i].bottom(2))
        p50.mix(3,40,PCR_plate.wells_by_name()[i].bottom(3))
    ...
    list_of_rows_4 = ['A4','B4','C4','D4','E4','F4','G4','H4']
    for i in list_of_rows_4:
        p50.pick_up_tip()
        p50.aspirate(Sample_Vol, Sample_plate.wells_by_name()[i].bottom(2))
        p50.dispense(Sample_Vol,PCR_plate.wells_by_name()[i].bottom(2))
        p50.mix(3,40,PCR_plate.wells_by_name()[i].bottom(3))
...
# Add Adapters
    for i in list_of_rows_1:
        ...
        p10.dispense(2,PCR_plate.wells_by_name()[i].bottom(2))
        p10.mix(3,10,PCR_plate.wells_by_name()[i].bottom(3))
        p10.blow_out(PCR_plate.wells_by_name()[i].bottom(10))
        p10.return_tip()
...
#
    ...
    for i in list_of_rows_1:
        ...
        p10.dispense(Lig_vol,PCR_plate.wells_by_name()[i].bottom(2))
        p10.mix(3,10,PCR_plate.wells_by_name()[i].bottom(3))
        p10.blow_out(PCR_plate.wells_by_name()[i].bottom(10))
        p10.return_tip()
    ...
    for i in list_of_rows_1:
        ...
        p10.dispense(Fill_vol,PCR_plate.wells_by_name()[i].bottom(2))
        p10.mix(3,10,PCR_plate.wells_by_name()[i].bottom(3))
        p10.blow_out(PCR_plate.wells_by_name()[i].bottom(10))
        p10.return_tip()
