...
m10.transfer(2, BGI_adapter.bottom(1), SA1.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA2.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA3.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA4.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA5.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA6.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA7.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA8.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA9.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA10.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA11.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(2, BGI_adapter.bottom(1), SA12.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)

### Addition of End repair mastermix to enzymes
m300.transfer(91, Lig_mastermix, Enzyme_Lig.bottom(2), mix_after=(5,30), blow_out=True)

### Addition of End repair mastermix to libraries
m10.transfer(8, Enzyme_Lig.bottom(1), SA1.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA2.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA3.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA4.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA5.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA6.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA7.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA8.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA9.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA10.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA11.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
m10.transfer(8, Enzyme_Lig.bottom(1), SA12.bottom(2),mix_after=(3,8) , new_tip='always',  blow_out =True)
