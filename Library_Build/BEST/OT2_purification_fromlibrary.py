def get_values(*names):
    import json
    _all_values = json.loads("""{"pipette_type":"p300_multi_gen2","pipette_mount":"left","sample_number":24,"sample_volume":50,"bead_ratio":1.5,"elution_buffer_volume":50,"incubation_time":10,"settling_time":5,"drying_time":5}""")
...
def run(protocol_context):
    ...
    for cycle in range(2):
        for target in samples:
            pipette.transfer(125, ethanol, target, air_gap=air_vol,
                             new_tip='once')
