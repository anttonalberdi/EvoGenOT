def get_values(*names):
    import json
    _all_values = json.loads("""{"pipette_type":"p300_multi","pipette_mount":"left","sample_number":48,"sample_volume":200,"bead_ratio":1,"elution_buffer_volume":50,"incubation_time":10,"settling_time":5,"drying_time":5}""")
