...
#### MODULES ####
tube_rack1 = labware.load('opentrons-tuberack-2ml-eppendorf', '3', share=True) #Forward
  #A1-A6: Tag1-6
  #B1-B6: Tag7-12
  #C1-C6: Tag13-18
  #D1-D6: Tag19-24
tube_rack2 = labware.load('opentrons-tuberack-2ml-eppendorf', '6', share=True) #Reverse
  #A1-A6: Tag1-6
  #B1-B6: Tag7-12
  #C1-C6: Tag13-18
  #D1-D6: Tag19-24
tube_rack3 = labware.load('opentrons-tuberack-2ml-eppendorf', '9', share=True) #Reverse
  #A1 = 1.5 ml ddH2O
  #A2 = 1.5 ml ddH2O
ice_rack1 = labware.load('PCR-strip-tall', '5', share=True)

#### TIP RACKS ####
#300 ul tip racks in slots 5 and 8
tipracks_200 = labware.load('opentrons-tiprack-300ul', '8')
...
#Transfer water
s50.transfer(dispvol, tube_rack3.wells('A1'), ice_rack1.cols('1','3','5')) 
s50.transfer(dispvol, tube_rack3.wells('A2'), ice_rack1.cols('1','3','5')) 
