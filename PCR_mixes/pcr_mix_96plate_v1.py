...
s50.transfer(indVol, reagent_rack.wells('C1'), pcr_plate.rows('1','2','3','4','5','6'), mix_before=(10, 50))
s50.transfer(indVol, reagent_rack.wells('C2'), pcr_plate.rows('7','8','9','10','11','12'), mix_before=(10, 50))

#### PRIMER DISTRIBUTION ####
m10.transfer(primerVol, primer_plate.wells(primercolsStr), pcr_plate.wells(platecolsStr), new_tip='always')
