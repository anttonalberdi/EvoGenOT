...
mag_deck.disengage()
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('1').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('2').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('3').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('5').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('4').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('6').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('7').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('8').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('10').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('9').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('11').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
m300.distribute(Binding_buffer_vol, Binding_buffer, sample_plate.cols('12').bottom(2), mix_after=(5,200), new_tip='always',  blow_out =True)
