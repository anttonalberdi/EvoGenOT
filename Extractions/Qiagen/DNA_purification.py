...
metadata = {
    ...
    'description': 'DNA purification of PowerSoil/Fecal extracts (C1 + bead beating)',
}
...
### Remove supernatant
m300.transfer(400, SA1.bottom(), Liquid_trash.top(-5), blow_out=True,new_tip='always')
m300.transfer(400, SA2.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA3.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA4.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA5.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA6.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA7.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA8.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA9.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA10.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA11.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
m300.transfer(400, SA12.bottom(), Liquid_trash.top(-5), blow_out=True, new_tip='always')
...
m300.transfer(400, SA1.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA2.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA3.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA4.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA5.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA6.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA7.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA8.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA9.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA10.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA11.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
m300.transfer(400, SA12.bottom(2), Liquid_trash.top(-5), new_tip='always', blow_out=True)
...
for target in samples:
    ...
    robot.head_speed(combined_speed=max(max_speed_per_axis.values()),**max_speed_per_axis)
    m300.set_flow_rate(aspirate=40, dispense=40)
    m300.transfer(EtOH_vol, EtOH2, target.bottom(6), air_gap=0, new_tip='never')
    m300.set_flow_rate(aspirate=50, dispense=50)
    m300.mix(3, 100, target.bottom(6))
    m300.delay(seconds=5)
    m300.move_to(target.top(-3))
...
m300.transfer(30, SA1.bottom(1), elution_plate('A1'), new_tip='always', blow_out=True)
m300.transfer(30, SA2.bottom(1), elution_plate('A2'), new_tip='always', blow_out=True)
m300.transfer(30, SA3.bottom(1), elution_plate('A3'), new_tip='always', blow_out=True)
m300.transfer(30, SA4.bottom(1), elution_plate('A4'), new_tip='always', blow_out=True)
m300.transfer(30, SA5.bottom(1), elution_plate('A5'), new_tip='always', blow_out=True)
m300.transfer(30, SA6.bottom(1), elution_plate('A6'), new_tip='always', blow_out=True)
m300.transfer(30, SA7.bottom(1), elution_plate('A7'), new_tip='always', blow_out=True)
m300.transfer(30, SA8.bottom(1), elution_plate('A8'), new_tip='always', blow_out=True)
m300.transfer(30, SA9.bottom(1), elution_plate('A9'), new_tip='always', blow_out=True)
m300.transfer(30, SA10.bottom(1), elution_plate('A10'), new_tip='always', blow_out=True)
m300.transfer(30, SA11.bottom(1), elution_plate('A11'), new_tip='always', blow_out=True)
m300.transfer(30, SA12.bottom(1), elution_plate('A12'), new_tip='always', blow_out=True)
mag_deck.disengage()
