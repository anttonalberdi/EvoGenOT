...
m1000 = instruments.P1000_Single(mount='left', tip_racks=[tipracks_1000_1, tipracks_1000_2])
...
m1000.transfer(Supernatant_vol, sample_plate.col('A1', 'B1', 'C1', 'D1', 'E1', 'F1', 'G1', 'H1').bottom(1), Trash.wells('A1').top(-5))
