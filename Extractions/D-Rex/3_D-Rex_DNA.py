...
m300.transfer(Elution_vol, DA7.bottom(), elution_plate_DNA.wells('A6'), new_tip='always',  blow_out =True, air_gap=30)
m300.transfer(Elution_vol, DA6.bottom(), elution_plate_DNA.wells('A7'), new_tip='always',  blow_out =True, air_gap=30)
