...
m300.transfer(Wash_1_vol, RA1.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA2.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA3.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA4.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA5.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA6.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA7.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA8.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA9.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA10.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA11.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(Wash_1_vol, RA12.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
...
m300.transfer(200, RA3.bottom(1), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA4.bottom(1), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA5.bottom(1), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA6.bottom(1), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA7.bottom(1), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA8.bottom(1), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA9.bottom(1), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
...
mag_deck.engage(height=16)
m300.delay(minutes=2)
m300.transfer(200, RA1.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA2.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA3.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA4.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA5.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA6.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA7.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA8.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA9.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA10.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA11.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
m300.transfer(200, RA12.bottom(2), Liquid_trash.top(-4), new_tip='always',  blow_out =True)
